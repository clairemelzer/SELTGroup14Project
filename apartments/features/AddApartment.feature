...
Scenario: Trying to add an apartment with out right parameters
  And I have visited the Details about "19 E Burlington St" page 
  And I have clicked on "Add Apartment for Building"
  When I have added an apartment with number "" and bedrooms "" and bathrooms "" and rent "" and utilities "" and laundry "true" and air "true" and balcony "true"
...
Scenario: Trying to add an apartment with invalid inputs
  And I have visited the Details about "19 E Burlington St" page 
  And I have clicked on "Add Apartment for Building"
  When I have added an apartment with number "a" and bedrooms "a" and bathrooms "a" and rent "a" and utilities "a" and laundry "true" and air "true" and balcony "true"
